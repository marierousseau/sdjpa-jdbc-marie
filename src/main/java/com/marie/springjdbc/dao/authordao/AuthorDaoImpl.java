package com.marie.springjdbc.dao.authordao;
...
public class AuthorDaoImpl implements AuthorDao {
    ...
    @Override
    public List<Author> findAuthorsByFirstNameOrLastName(String firstName, String keyword) {

        return authorRepository.findAuthorsByFirstNameOrLastName(firstName, keyword);
    }
}
